...
function AddJobs() {
  ...
  const submitAllData = () => {
    ...
    formData.append("blog_Heading", inputData.jobTitle);
    formData.append("blog_Desciption", inputData.description);

    axios
      .post(`${baseUrl}createBlog/${localStorage.getItem("id")}`, formData)
      .then((response) => {
