                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">
                        {" "}
                        {row.job_Description.length>20 ? `${row.job_Description.substring(0, 18)}...` : row.job_Description}
                      </TableCell>
                      ...
                      <TableCell align="left">
                         {row.JobImage ? (
                          <img
                            src={"http://13.51.205.211:2001/" + row.JobImage}
                            alt="loading"
                            style={{
                              width: "50px",
                              height: "50px",
                      ...
                      <TableCell align="left">{row.Job_Experience}</TableCell>
                      <TableCell align="center">
                        {moment(row.createdAt).format("MMM Do YY")}
                      </TableCell>
                      <TableCell align="center">
                        {moment(row.job_expired_Date).format("MMM Do YY")}
                      </TableCell>
                      <TableCell align="left">
                        {
                          <VisibilityIcon
